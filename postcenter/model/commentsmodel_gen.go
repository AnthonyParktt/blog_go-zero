...
func (m *defaultCommentsModel) Insert(ctx context.Context, data *Comments) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.DeletedAt, data.UserId, data.PostId, data.Content)
	return ret, err
}
...
func (m *defaultCommentsModel) Update(ctx context.Context, data *Comments) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.DeletedAt, data.UserId, data.PostId, data.Content, data.Id)
	return err
}
